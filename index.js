...
`;
    ...
    if (!depthTextureExt) {
        console.warn("WEBGL_depth_texture is not available; framebuffer depth output may be limited.");
    }
    ...
    graphics.setRenderTarget(createRenderTarget(canvas.width, canvas.height));
